...
public:
    ...
    const std::string_view getRegex( const Stack< Variable >& stack ) const;

    RegexCacao( const std::string regex, const RegexType rtype = EcmaRegex );

    static std::list<Variable*>& find_env_variables( const std::string mstr, const RegexTypeCacao rtc = CacaoType );
    static std::list<Variable*>& find_env_variables_store( const std::string mstr, const RegexTypeCacao rtc = CacaoType );
    static std::list<Variable*>& find_env_variables_read( const std::string mstr, const RegexTypeCacao rtc = CacaoType );
    static std::list<Variable*>& find_env_variables_set( const std::string mstr, const RegexTypeCacao rtc = CacaoType );
    ...
    public:
        ...
        Match& regex( const std::string str_regex, const RegexType regex_type = RegexType::CacaoRegex ) const;
        const List& regexMatchAll( const std::string str_regex, const RegexType regex_type = RegexType::EcmaRegex ) const;
        ...
        public:
            ...
            List( const std::list< Match* >& other );
    ...
    const Match::List& match( const std::string mstr ) const;
    const Match::Dict& matchAll( const std::initializer_list<std::string> il_mstr ) const;
    const Match& matchOnce( const std::string mstr ) const;
    ...
    public:
        ...
        MatchingMap( const std::string str_or_regex, const enum Type mtype = Type::Regex
                   , const enum RegexType rtype = RegexType::ICase
        );
        ...
        // iterator insert_or_assign_ranges( std::initializer_list<const_iterator> ranges );

        operator std::basic_string<char>() const;

        class ResultList
            :   public std::list< MatchingDict* >
        {
        public:
        ...
        class ResultMap
            :   public std::multimap< std::string, Matching* >
        {
        public:
            const std::string_view rgx;
            const std::string_view str;
        ...
        public:
            ...
            Result( Match::List& ml, const PrefixSuffix& prfsuf, const RegexType rtype = RegexType::ICase );
        };
        ...
        static MatchingMap& getMatchingMap( const std::string mstr
                                                , const std::string regex
    ...
    MatchingMap& getMatching( const std::string mstr, const std::string regex
                                  , const bool matchAllPositions = true
                                  , const size_t matchingPositionStart = 0
                                  , const size_t matchingPositionEnd = 0 ) const;
    MatchingMap& getMatching( const std::string mstr
                                  , const bool matchingMapIsRegex = true
                                  , const bool matchAllPositions = true
                                  , const size_t matchingPositionStart = 0
                                  , const size_t matchingPositionEnd = 0 ) const;
    MatchingMap& getMatching( const PrefixSuffix& prefixsuffix
